    ...
    public class gUserModuleManager
    {
        public static List<ApplicationUser> GetAllUsers()
        {
           List<ApplicationUser> model;
            ...
            {
                string qry = $"select Email, Password as PasswordHash, DoctorID as Id, Office_Number, Branch_Number, Provider, Salutation, AuthenticationPhone, LastName, FirstName, Initials, Phone, Fax, AddressLine1, AddressLine2, AddressLine3, City, Province, Country, PostalCode, PhotoImageURL, WebsiteURL, ActivationStatus, LanguageSelected, DateFormat,  serial_number, cust_id, Providerrange, UserName, NormalizedUserName, NormalizedEmail, EmailConfirmed, SecurityStamp, ConcurrencyStamp, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnabled, AccessFailedCount, Office_Sequence, IsSystemAdministrator, IsAdministrator, IsDisplaySummary, IsDefaultUser from authentication";
        ...
        public static ApplicationUser GetUserById(int Id)
        {
            ...
            using (var db = new Database(DbConfiguration.LtcSystem))
            {
                string qry = $"select Email, Password as PasswordHash,SecurityStamp,ConcurrencyStamp, DoctorID as Id, Office_Number, Branch_Number, Provider, Salutation, AuthenticationPhone, LastName, FirstName, Initials, Phone, Fax, AddressLine1, AddressLine2, AddressLine3, City, Province, Country, PostalCode,PhotoImageURL, WebsiteURL, ActivationStatus, LanguageSelected, DateFormat,  serial_number, cust_id, Providerrange, UserName, NormalizedUserName, NormalizedEmail, EmailConfirmed, SecurityStamp, ConcurrencyStamp, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnabled, AccessFailedCount, Office_Sequence, IsSystemAdministrator, IsAdministrator, IsDisplaySummary, IsDefaultUser from authentication WHERE DoctorID={Id}";
