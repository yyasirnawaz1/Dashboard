        ...
        public static byte[] GeneratePdfArray(string content, string filePath)
        {
            ...
            foreach (var element in result)
            {
                if (element.type == "header")
                    ...
                    html += "<div class='form-group'><button type='button' class='btn btn-primary'>" + element.label +
                            "</button><p></div>";
                ...
                if (element.userData != null && element.userData[0] != string.Empty)
                {
                    ...
                    if (element.type == "textarea")
                        ...
                        html += "<div class='form-group'><p><i class='fa fa-star-half-o' style='font-size:24px;color:orange'></i></p></div>";
                    else
                        html += "<div class='form-group'><label>" + element.label +
                                "</label><input class='form-control' id=" + element.name + " value = '";
                    ...
                    html = html.Remove(html.Length - 1, 1);
                    if (element.type == "textarea" || element.type == "starRating")
                        html += "</div>";
                    else
                        html += "' /></div>";
                }
