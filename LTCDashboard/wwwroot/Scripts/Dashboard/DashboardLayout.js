...
var Dashboard = {
    ...
    TotalNetProduction: '<div id="cardStart-{name}" class="col col-lg-3 col-md-4 col-sm-6 cardStart order-{order}"><div id="card-{name}" class="card bg-teal-400"><div class="card-body dashboardCard pt-1 pb-1"><div class="d-flex cardHeading"><h3 class="font-weight-semibold mb-0 font-variant-smallCaps">{heading}</h3><div class="list-icons ml-auto"><a class="icon-stats-growth chartButton" onclick="openChart(\'{name}\', \'{heading}\')"></a><a class="list-icons-item" data-action="remove" onclick="Dashboard.removeCard(this)" data-name="{name}"></a></div></div><div class="d-flex justify-content-center cardContent"><span id="card-{name}-value" class="font-weight-semibold mb-0 font-size-xs">0</span></div><div class="d-flex justify-content-end cardContent"><img src="/Resources/Images/pivotIcon.png" onclick="Dashboard.loadChartBreakdownData(\'{name}\',\'{filtertypes}\')" class="pivoticon" /><img src="/Resources/Images/spreadsheetIcon.png" onclick="DashboardSpreadSheet.loadChartSpreadSheetData(\'{name}\',\'{filtertypes}\')" class="spreadsheeticon" /></div></div></div></div>',
    TotalPaymentReceipt: '<div id="cardStart-{name}" class="col col-lg-3 col-md-4 col-sm-6 cardStart order-{order}"><div id="card-{name}" class="card bg-pink-400"><div class="card-body dashboardCard pt-1 pb-1"><div class="d-flex cardHeading"><h3 class="font-weight-semibold mb-0 font-variant-smallCaps">{heading}</h3><div class="list-icons ml-auto"><a class="icon-stats-growth chartButton" onclick="openChart(\'{name}\', \'{heading}\')"></a><a class="list-icons-item" data-action="remove" onclick="Dashboard.removeCard(this)" data-name="{name}"></a></div></div><div class="d-flex justify-content-center cardContent"><span id="card-{name}-value" class="font-weight-semibold mb-0 font-size-xs">0</span></div><div class="d-flex justify-content-end cardContent"><img src="/Resources/Images/pivotIcon.png" onclick="Dashboard.loadChartBreakdownData(\'{name}\',\'{filtertypes}\')" class="pivoticon" /><img src="/Resources/Images/spreadsheetIcon.png" onclick="DashboardSpreadSheet.loadChartSpreadSheetData(\'{name}\',\'{filtertypes}\')" class="spreadsheeticon" /></div></div></div></div>',
    TotalNetPaymentReceipt: '<div id="cardStart-{name}" class="col col-lg-3 col-md-4 col-sm-6 cardStart order-{order}"><div id="card-{name}" class="card bg-blue-400"><div class="card-body dashboardCard pt-1 pb-1"><div class="d-flex cardHeading"><h3 class="font-weight-semibold mb-0 font-variant-smallCaps">{heading}</h3><div class="list-icons ml-auto"><a class="icon-stats-growth chartButton" onclick="openChart(\'{name}\', \'{heading}\')"></a><a class="list-icons-item" data-action="remove" onclick="Dashboard.removeCard(this)" data-name="{name}"></a></div></div><div class="d-flex justify-content-center cardContent"><span id="card-{name}-value" class="font-weight-semibold mb-0 font-size-xs">0</span></div><div class="d-flex justify-content-end cardContent"><img src="/Resources/Images/pivotIcon.png" onclick="Dashboard.loadChartBreakdownData(\'{name}\',\'{filtertypes}\')" class="pivoticon" /><img src="/Resources/Images/spreadsheetIcon.png" onclick="DashboardSpreadSheet.loadChartSpreadSheetData(\'{name}\',\'{filtertypes}\')" class="spreadsheeticon" /></div></div></div></div>',
    TotalNetHygenistProduction: '<div id="cardStart-{name}" class="col col-lg-3 col-md-4 col-sm-6 cardStart order-{order}"><div id="card-{name}" class="card bg-success"><div class="card-body dashboardCard pt-1 pb-1"><div class="d-flex cardHeading"><h3 class="font-weight-semibold mb-0 font-variant-smallCaps">{heading}</h3><div class="list-icons ml-auto"><a class="icon-stats-growth chartButton" onclick="openChart(\'{name}\', \'{heading}\')"></a><a class="list-icons-item" data-action="remove" onclick="Dashboard.removeCard(this)" data-name="{name}"></a></div></div><div class="d-flex justify-content-center cardContent"><span id="card-{name}-value" class="font-weight-semibold mb-0 font-size-xs">0</span></div><div class="d-flex justify-content-end cardContent"><img src="/Resources/Images/pivotIcon.png" onclick="Dashboard.loadChartBreakdownData(\'{name}\',\'{filtertypes}\')" class="pivoticon" /><img src="/Resources/Images/spreadsheetIcon.png" onclick="DashboardSpreadSheet.loadChartSpreadSheetData(\'{name}\',\'{filtertypes}\')" class="spreadsheeticon" /></div></div></div></div>',
    TotalNetDoctorProduction: '<div id="cardStart-{name}" class="col col-lg-3 col-md-4 col-sm-6 cardStart order-{order}"><div id="card-{name}" class="card bg-pink-400"><div class="card-body dashboardCard pt-1 pb-1"><div class="d-flex cardHeading"><h3 class="font-weight-semibold mb-0 font-variant-smallCaps">{heading}</h3><div class="list-icons ml-auto"><a class="icon-stats-growth chartButton" onclick="openChart(\'{name}\', \'{heading}\')"></a><a class="list-icons-item" data-action="remove" onclick="Dashboard.removeCard(this)" data-name="{name}"></a></div></div><div class="d-flex justify-content-center cardContent"><span id="card-{name}-value" class="font-weight-semibold mb-0 font-size-xs">0</span></div><div class="d-flex justify-content-end cardContent"><img src="/Resources/Images/pivotIcon.png" onclick="Dashboard.loadChartBreakdownData(\'{name}\',\'{filtertypes}\')" class="pivoticon" /><img src="/Resources/Images/spreadsheetIcon.png" onclick="DashboardSpreadSheet.loadChartSpreadSheetData(\'{name}\',\'{filtertypes}\')" class="spreadsheeticon" /></div></div></div></div>',
    ...
    CancellationAndNoShows: '<div id="cardStart-{name}" class="col-md-4 cardStart order-{order}"><div id="card-{name}" class="card dashboardGraph"><div class="card-header header-elements-inline"><h5 class="card-title font-variant-smallCaps">{heading}</h5><div class="header-elements"><div class="list-icons"><a class="icon-stats-growth chartButton" onclick="openChart(\'{name}\', \'{heading}\')"/><a class="list-icons-item" data-action="remove" onclick="Dashboard.removeCard(this)" data-name="{name}"/></div></div></div><div class="card-body"><div class="chart-container"><div class="chart mediumBarGraph" id="{name}-chart" /></div></div><div class="d-flex justify-content-end cardContent"><img src="/Resources/Images/pivotIcon.png" onclick="Dashboard.loadChartBreakdownData(\'{name}\',\'{filtertypes}\')" class="pivoticon" /><img src="/Resources/Images/spreadsheetIcon.png" onclick="DashboardSpreadSheet.loadChartSpreadSheetData(\'{name}\',\'{filtertypes}\')" class="spreadsheeticon" /></div></div></div>',
    ...
    ServiceAnalysis: '<div id="cardStart-{name}" class="col-md-4 cardStart order-{order}"><div id="card-{name}" class="card dashboardGraph"><div class="card-header header-elements-inline"><h5 class="card-title font-variant-smallCaps">{heading}</h5><div class="header-elements"><div class="list-icons"><a class="icon-stats-growth chartButton" onclick="openChart(\'{name}\', \'{heading}\')"></a><a class="list-icons-item" data-action="remove" onclick="Dashboard.removeCard(this)" data-name="{name}"></a></div></div></div><div class="card-body"><div class="chart-container"><div class="chart" id="{name}-chart" data-charttype="pie"></div></div></div><div class="d-flex justify-content-end cardContent"><img src="/Resources/Images/pivotIcon.png" onclick="Dashboard.loadChartBreakdownData(\'{name}\',\'{filtertypes}\')" class="pivoticon" /><img src="/Resources/Images/spreadsheetIcon.png" onclick="DashboardSpreadSheet.loadChartSpreadSheetData(\'{name}\',\'{filtertypes}\')" class="spreadsheeticon" /></div></div></div>',
                ...
                if (data.Success) {
                    ...
                    $.each(data.Data, function (i, data) {
                        ...
                        if (Dashboard.userCharts.filter(x => x.Chart_Id == data.ID).length > 0) {
                            Dashboard.loadedCharts.push({ chartId: data.ID, chartName: data.Name, chartTitle: data.Title, position: data.Position, order: data.Order, filtertypes: data.FilterTypes });
                        } else {
                            var html = Dashboard.selectionHTML
                                ...
                                .replace(/{types}/g, data.FilterTypes)
