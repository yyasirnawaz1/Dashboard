                ...
                W = function (r) {
                    var o = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                        ...
                        l = [q("a", null, {
                            type: "remove",
                            id: "del_" + x.lastID,
                            className: "del-button btn fa fa-remove delete-confirm",
                            title: f.default.get("removeMessage")
                        }), q("a", null, {
                            type: "edit",
                            id: x.lastID + "-edit",
                            className: "toggle-form btn fa fa-pencil",
                            title: f.default.get("hide")
                        }), q("a", null, {
                            type: "copy",
                            id: x.lastID + "-copy",
                            className: "copy-button btn fa fa-plus",
