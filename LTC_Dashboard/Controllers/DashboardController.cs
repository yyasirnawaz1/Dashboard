...
namespace LTCDashboard.Controllers
{
    public class DashboardController : BaseController
    {
            ...
            IOptions<Mapping> mapping)
        {
            ...
            _gChartManager = new gChartManager(configuration,mapping);
        }
        ...
        [HttpPost]
        public ActionResult AddCard(int chartId, string defaultFilterTypes)
        {
            try
            {
                gDashboardChartManager.AddUserChart(chartId, UserId, OfficeSequence, defaultFilterTypes);
        ...
        [HttpPost]
        public ActionResult GetMappingDetail()
        {
            try
            {
                return Json(new { Success = true, Data = _mapping.Map });
            }
            catch (Exception ex)
            {
                return Json(new { Sucess = false });
