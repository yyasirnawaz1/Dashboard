...
var Newsletter = function () {
    return {
        ...
        initKendoWindow: function () {
            //if (!isKendoWindowLoaded) {

            //    $("#templateEditorWindow").kendoWindow({
            //        title: "--" + "", // get current selected template name
            ...
            //    $("#templateEditorWindow").removeClass('hide');
        ...
        loadSystemTemplatesForDuplication: function () {
            $.ajax({
                type: "GET",
                data: {
                    "OfficeId": function (d) {
        ...
        saveNewsletterEditor: function (isSave) {
            ...
            Layout.showLoader();
            $.ajax({
                url: '/Newsletter/SaveUserNewsletterEditor',
                method: 'POST',
                data: JSON.stringify(data),
                contentType: 'application/json',
                dataType: 'json',
                success: function (d) {
                    ...
                    $('#divPreviewUserNewsLetter').html('<iframe id="previewUserNewsLetter" class="" style="min-height:400px; width:100%;"></iframe>');
                },
                error: function (xhr, data, errorThrown) {
                    Layout.hideLoader();
                    alert('error');
        ...
        resetNewsletterEditor: function () {
            ...
            this.loadTemplateDetailInEditor(true, SelectedUserDefinedTemplateId, isForDuplication);
        },
